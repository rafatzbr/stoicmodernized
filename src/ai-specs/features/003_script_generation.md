...
- **Viewer-delivery boundary**: Stoic Modernized shorts must use a subscribe-style CTA only. Scripts may not promise to send viewers checklists, guides, templates, PDFs, links, or other resources in exchange for comments, replies, DMs, or messages; generation prompts include this rule and validation rejects any remaining delivery promise.
